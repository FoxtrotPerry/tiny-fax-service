// TODO: Remove after @types/bun is updated to v1.2.21
...
declare module "bun" {
  ...
  type ArrayBufferView<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> =
    NodeJS.TypedArray<TArrayBuffer> | DataView<TArrayBuffer>;
  ...
  type MessageEventSource = Bun.__internal.UseLibDomIfAvailable<
    "MessageEventSource",
    undefined
  >;
  ...
  namespace __internal {
    type LibDomIsLoaded = typeof globalThis extends { onabort: any }
      ? true
      : false;
    ...
    type UseLibDomIfAvailable<
      GlobalThisKeyName extends PropertyKey,
      Otherwise
    > =
    ...
    type DistributedMerge<T, Else = T> = T extends T
      ? Merge<T, Exclude<Else, T>>
      : never;
  }
  ...
  type MessageEvent<T = any> = Bun.__internal.UseLibDomIfAvailable<
    "MessageEvent",
    BunMessageEvent<T>
  >;
  ...
  interface TLSOptions {
    ...
    ca?:
      ...
      | BufferSource
      | BunFile
      | Array<string | BufferSource | BunFile>
      | undefined;
    /**
  ...
  > =
    ...
    | (Omit<WebSocketServeOptions<T>, "fetch"> & {
        routes: {
          [K in keyof R]: RouterTypes.RouteValueWithWebSocketUpgrade<
            Extract<K, string>
          >;
        };
        fetch?: (
  ...
  namespace unsafe {
    ...
    function arrayBufferToString(
      buffer: Uint8Array<ArrayBuffer> | ArrayBufferLike
    ): string;
